...
class Loan {
    constructor(loanId, userId, stateId, loanTypeId, system, currency, capital, interest, duration) {
      this.loanId = loanId;
      this.userId = userId;
    ...
    async createLoan(userId, system, currency, capital, interest, duration) {
        try {
          ...
          // Create loan type
          const createLoanTypeQuery = 'INSERT INTO loantype (loanid, system, currency, capital, interest, duration) VALUES ($1, $2, $3, $4, $5, $6) RETURNING loantypeid';
          const createLoanTypeValues = [null, system, currency, capital, interest, duration];
